...
import { righteousOffspringDuas } from "../data/righteousOffspringDuaData";

const RighteousOffspringDuaPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="bg-black p-4 flex items-center justify-between">
        ...
        <h2 className="text-xl font-arabic font-bold">دعاء للذرية الصالحة</h2>
        <div className="w-5"></div> {/* Placeholder for alignment */}
      </div>

      {/* Content */}
      <div className="flex-1 p-4 overflow-y-auto">
        {righteousOffspringDuas.map((dua) => (
...
export default RighteousOffspringDuaPage;
