...
import { safaMarwaDuas } from "../data/safaMarwaDuaData";

const SafaMarwaDuaPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="bg-black p-4 flex items-center justify-between">
        ...
        <h2 className="text-xl font-arabic font-bold">دعاء الوقوف على الصفا والمروة</h2>
        <div className="w-5"></div> {/* Placeholder for alignment */}
      </div>

      {/* Content */}
      <div className="flex-1 p-4 overflow-y-auto">
        {safaMarwaDuas.map((dua) => (
...
export default SafaMarwaDuaPage;
